...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Lianzhao', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个训狗师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lianzhao.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '四足机器人, 运动控制, 运动规划', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL:
    process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'lianzhao1997@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB:
    process.env.NEXT_PUBLIC_CONTACT_GITHUB ||
    'https://github.com/LianzhaoZhang/', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI:
    process.env.NEXT_PUBLIC_CONTACT_BILIBILI ||
    'https://space.bilibili.com/97514182?spm_id_from=333.1007.0.0', // B站主页
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    ...
    },
    {
      ...
      url: 'https://music.163.com/song/media/outer/url?id=2137895478.mp3',
      cover:
    ...
    },
    {
      name: '故乡',
      artist: 'Falcom Sound Team jdk',
      url: 'https://music.163.com/song/media/outer/url?id=168107.mp3',
      cover:
        'http://p2.music.126.net/2CSVBewDknbP3c9m_G9Qeg==/112150186046323.jpg'
    },
    {
      name: '月光の雲海',
      artist: 'Falcom Sound Team jdk',
      url: 'https://music.163.com/song/media/outer/url?id=442760.mp3',
      cover:
...

    {
      name: 'Go Time',
      artist: 'Falcom Sound Team jdk',
      url: 'https://music.163.com/song/media/outer/url?id=29717271.mp3',
      cover:
        'http://p1.music.126.net/TJe468hZr_0ndQRfTAKdqA==/3233663697760186.jpg'
    },
    {
      name: 'いつも何度でも',
      artist: 'Falcom Sound Team jdk',
      ...
      cover:
        'http://p2.music.126.net/GYWkXtrnAawOWO2nfLg3PA==/109951163028865726.jpg'
    },
    {
      name: '风を共に舞う気持ち',
      artist: 'Falcom Sound Team jdk',
